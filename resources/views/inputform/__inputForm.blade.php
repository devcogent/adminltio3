            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        {{-- <a class="btn btn-warning" href="download-csv/{{$crmform->form_name}}" style="float: right;" title="Download your csv* format for uplaod data" download >Download</a>
                        <a class="btn btn-success" href="upload/{{$crmform->form_name}}" style="float: right;">Upload</a> --}}
                                        ...
                                        switch ($form_field->field_type) {
                                            case "text": ?>
                                                <div class="col-md-4">
                                                    ...
                                                    <input @if($form_field->is_numaric=='yes')
                                            ...
                                            case "mobile": ?>
                                                <div class="col-md-4">
                                                    <label style="text-transform: uppercase;">{{$form_field->label_name}}</label>
                                                    <input @if($form_field->field_type=='mobile')
                                                    pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length=={{$form_field->length}} ) return false;"
                                                    @endif
                                            ...
                                            case "zip": ?>
                                                <div class="col-md-4">
                                                    <label style="text-transform: uppercase;">{{$form_field->label_name}}</label>
                                                    <input @if($form_field->field_type=='zip')
                                                    pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length=={{$form_field->length}} ) return false;"
                                                    @endif
                                            ...
                                            ?>
                                                <div class="col-md-4">
                                                    <label style="text-transform: uppercase;">{{$form_field->label_name}}</label>
                                                    <input id="datefield" min='{{$min}}' max='{{$max}}' type="datetime-local" placeholder="Enter {{$form_field->label_name}}" class="form-control" name="{{$form_field->field_name}}" {{ ($form_field->is_required=='yes') ? 'required' : '' }}>
