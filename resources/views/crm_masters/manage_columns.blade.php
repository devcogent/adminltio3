        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
           <div class="card card-info">
            <div class="card-header">
                <h5>Manage CRM Options <a href="{{route('crmmaster')}}" class="btn  btn-danger btn-sm float-right"> <<i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp; Go Back</a></h5>
             </div>
             <div class="card-body">
                           ...
                           {{ csrf_field() }}
                            <div class="row">
                                ...
                                <div class="form-group col-md-5">
                                    <select class="form-control select2bs4 " style="width: 100%;" name="crmform"
                                        id="crmform">
